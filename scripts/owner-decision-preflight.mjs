...
const DECISIONS = {
  pdf: {
    ...
    executionAfterApproval: 'PDF is afgerond; deze preflight voert niets uit.',
    rollback: 'Revert de dependency- en rendererwijziging als build, tests of audit falen.',
    stopRules: ['Stop bij scope buiten PDF evidence.', 'Stop bij verzoek om echte e-mail zonder aparte goedkeuring.'],
    nextPrompt: 'Geen PDF-prompt meer nodig; resterende functionele beslissing is e-mail.',
  },
  'production-cutover': {
