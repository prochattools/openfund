...
Status: Release Candidate 7 — roadmap 100% through Phase 17; Phase 17 complete; formula-based monthly chaining model; read-only production audit passed on 2026-07-09; 2024 closing 1218415 confirmed; schema cutover, historische import, database credential finalisatie, provider secret remediation, echte PDF, en echte e-mailverzending zijn volledig afgerond 2026-07-08
Taal: Nederlands
