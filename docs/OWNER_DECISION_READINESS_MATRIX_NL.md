...
Status: Release Candidate 6 — schema cutover, historische import, database credential finalisatie, alle provider secrets, en echte PDF-renderer afgerond; echte e-mail geblokkeerd
Taal: Nederlands  
...
|------------|--------|----------|--------------------|------------------------|-----------|--------------|-------------------------------|
| Echte PDF-renderer | Voltooid 2026-07-08 | `pdfkit` renderer toegevoegd; PDF artifact media type `application/pdf`; HTML/XLSX behouden; zie `docs/REAL_PDF_RENDERER_EVIDENCE_NL.md` | Echte e-mail blijft geblokkeerd | — | — | `npm test -- --test-name-pattern "report artifact"` | — (voltooid) |
| Productiemigratie/cutover | Schema afgerond 2026-07-07 | Schema finance gedeployed op PostgreSQL 15.8; 4 migraties; 30 tabellen geverifieerd; zie `docs/PRODUCTION_SCHEMA_CUTOVER_EVIDENCE_NL.md` | Echte e-mail blijft geblokkeerd | — | — | — | — |
| Historische productie-import | Voltooid 2026-07-07 | 902 transacties (268 2024 + 413 2025 + 221 2026), 681 boekingen, 4 bronbestanden, 2026 gedeeltelijk/open en niet afgesloten; zie `docs/PRODUCTION_HISTORICAL_IMPORT_EVIDENCE_NL.md` | Echte e-mail blijft geblokkeerd | — | — | `npm test -- --test-name-pattern "historical"` | — (voltooid) |
...
| Geheimen roteren | Voltooid 2026-07-07 | finance_user-credential geroteerd; oud credential afgewezen; nieuw credential geverifieerd; historische totalen herbevestigd; zie `docs/PRODUCTION_SECRET_ROTATION_EVIDENCE_NL.md` | Echte e-mail blijft geblokkeerd | — | — | — | — (voltooid) |
| App/provider geheimremediatie | Voltooid 2026-07-08 | Alle provider secrets geroteerd en toegepast; app redeployed; health en readiness geverifieerd; zie `docs/PRODUCTION_APP_PROVIDER_SECRET_ROTATION_EVIDENCE_NL.md` | Echte e-mail blijft geblokkeerd | — | — | — | — (voltooid) |
...
- Echte e-mailverzending blijft geblokkeerd.
