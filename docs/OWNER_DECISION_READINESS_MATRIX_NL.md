...
Status: Release Candidate 6 — schema cutover, historische import, database credential finalisatie, en alle provider secrets afgerond; Clerk/Resend/New Relic geroteerd 2026-07-08; echte e-mail en PDF geblokkeerd
Taal: Nederlands  
...
| App/provider geheimremediatie | Voltooid 2026-07-08 | Alle provider secrets geroteerd en toegepast; app redeployed; health en readiness geverifieerd; zie `docs/PRODUCTION_APP_PROVIDER_SECRET_ROTATION_EVIDENCE_NL.md` | Echte e-mail en PDF blijven geblokkeerd | — | — | — | — (voltooid) |
