...
Current gate: Release Candidate 4 owner review / roadmap closeout and owner decisions; all safe pre-approval hardening is complete (847 tests), and owner decisions remain required before production cutover, historical production import, PDF dependency, email provider, push, production secret rotation, and production PostgreSQL version confirmation
```
